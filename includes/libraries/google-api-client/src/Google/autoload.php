...
if (!file_exists($file)) {
  ...
  $exception .= ' See the instructions at https://github.com/google/google-api-client#installation.';
  throw new Exception($exception);
}

$error = 'google-api-client\'s autoloader was moved to vendor/autoload.php in 2.0.0. This ';
